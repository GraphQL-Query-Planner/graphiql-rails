...
var _lifecycle2 = _interopRequireDefault(lifecycle);
...
var _defaultProps2 = _interopRequireDefault(defaultProps);
...
var ReactTable = function (_Methods) {
  ...
  return ReactTable;
}((0, _methods2.default)((0, _lifecycle2.default)(React$1.Component)));
...
var ReactTable = unwrapExports(lib);
var lib_1 = lib.ReactTableDefaults;
...
var treeTableHOC = unwrapExports(treeTable);
...
var ChartComponent = function (_React$Component) {
  ...
  ChartComponent.prototype.render = function render() {
    ...
    return React$1.createElement('canvas', {
      ref: this.ref,
      height: height,
      width: width,
...
ChartComponent.propTypes = {
  data: propTypes$3.oneOfType([propTypes$3.object, propTypes$3.func]).isRequired,
  getDatasetAtEvent: propTypes$3.func,
  getElementAtEvent: propTypes$3.func,
  getElementsAtEvent: propTypes$3.func,
  height: propTypes$3.number,
  legend: propTypes$3.object,
  onElementsClick: propTypes$3.func,
  options: propTypes$3.object,
  plugins: propTypes$3.arrayOf(propTypes$3.object),
  redraw: propTypes$3.bool,
  ...
  datasetKeyProvider: propTypes$3.func
};
...
var Doughnut = function (_React$Component2) {
  ...
  Doughnut.prototype.render = function render() {
    ...
    return React$1.createElement(ChartComponent, _extends({}, this.props, {
...
var Plugin = React.createElement("div", null);

var viewer = function viewer(results) {
  if (results) {
...
var resolverDetails = function resolverDetails(results) {
  if (!results) {
    return;
  }
...
var queryDetails = function queryDetails(results) {
  if (!results) {
    return;
  }
  var resultsObj = JSON.parse(results);
  if (resultsObj) {
    ...
    var details = resolvers.map(function (resolver) {
...
function formatToMS(time) {
  var NS_TO_MS = 1000000;
  return (time / NS_TO_MS).toFixed(2);
}

var apolloTracing = function apolloTracing(results) {
  if (!results) {
    return;
  }
  var resultsObj = JSON.parse(results);
  if (resultsObj) {
    ...
    var msec = formatToMS(tracing.duration);

    var resolvers = tracing.execution && tracing.execution.resolvers;
    if (!resolvers) {
      return;
    }

    var labels = resolvers.map(function (resolver) {
      return resolver.path.join(", ");
    });
    var startData = resolvers.map(function (resolver) {
      return formatToMS(resolver.startOffset);
    });
    ...
    return React.createElement(
      ...
      React.createElement(HorizontalBar, { data: data, options: options })
    );
  }
};
...
exports.resolverDetails = resolverDetails;
exports.queryDetails = queryDetails;
exports.apolloTracing = apolloTracing;
